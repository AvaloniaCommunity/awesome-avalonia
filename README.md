...
- [PrismAvaloniaWithMSDITemplate](https://github.com/0use-TE/PrismAvaloniaWithMSDITempalte) - A template with Prism.avalonia and Prism,can run in windows,wasm,linux.
