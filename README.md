...
- [Desktop Apps with Avalonia and FSharp](https://dev.to/tunaxor/desktop-apps-with-avalonia-and-fsharp-4n21).
- [AvaloniaUI IoT LED Bar sample](https://github.com/SuperJMN/Avalonia-IoT-LedBar).
...
## Videos
- [Nikita Tsukanov - AvaloniaUI - cross-platform XAML-oriented .NET UI framework](https://www.youtube.com/watch?v=DLHhZJkSqWk).
- [Avalonia libdrm/egl/libinput backend progress](https://www.youtube.com/watch?v=t8Ww17iPdqs).
- [Dock - docking layout system for Avalonia applications - docking between windows](https://www.youtube.com/watch?v=KHH23BFgU30).
- [A Cross Platform .NET UI Framework - Hello World in Avalonia UI](https://www.youtube.com/watch?v=rho26Ik30D4).
- [Avalonia SVG image support](https://www.youtube.com/watch?v=UHmlfBMq6W4).
- [Svg.Skia an SVG rendering library AvaloniaUI demo](https://www.youtube.com/watch?v=6hnVwWOeOt8).
- [Avalonia acting as a VNC server](https://www.youtube.com/watch?v=HAyHIvSzweM).
- [AvaloniaUI Theme Manager](https://www.youtube.com/watch?v=btsaMx9rI_I).
- [AvaloniaUI running without X server on top of /dev/fb0 and libevdev2](https://www.youtube.com/watch?v=NkTPfBfDmtA).

## Articles
- [What would a cross-platform .NET UI Framework look like? Exploring Avalonia](https://www.hanselman.com/blog/WhatWouldACrossplatformNETUIFrameworkLookLikeExploringAvalonia.aspx).
- [Avalonia, a big candidate to create cross-platform apps with XAML 😎📲](https://www.idiwork.com/avalonia-a-big-candidate-to-create-crossplatform-apps-with-xaml/).
- [A Cross-Platform GUI Theme for Desktop .NET Core Applications](https://link.medium.com/J3ZeqsK2F6) - Getting started with building awesome cross-platform user interfaces with Avalonia framework and a modern UI theme.
...
## Other Languages
- [Никита Цуканов — AvaloniaUI — первый кроссплатформенный XAML UI-фреймворк с поддержкой .NET Core](https://www.youtube.com/watch?v=8qzqweimcFs) - Video.
- [CLRium #3: Кросс-платформенная разработка с использованием AvaloniaUI](https://www.youtube.com/watch?v=6uq1-ii26Es) - Video.
- [XAML-Tipp: Avalonia – eine Cross-Plattform-Lösung für XAML](https://entwickler.de/online/windowsdeveloper/xaml-cross-plattform-loesung-579812969.html) - Article.
- [🔮内生安全建模工具，基于.Net Core 3.0的Avalonia跨平台桌面应用。](https://github.com/LauZyHou/sbid-ava) - Project.
